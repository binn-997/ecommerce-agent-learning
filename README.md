...
> 想逐个模块学习源码，请使用：[Amazon AI Platform 逐代码学习手册](docs/CODE_LEARNING_GUIDE.md)。<br>
> Docker 完全零基础读者请阅读：[Docker 与 Docker Compose 零基础学习手册](docs/DOCKER_BEGINNER_GUIDE.md)。
...
完整周计划、避坑矩阵、验收条件与面试 Point 见 [docs/LEARNING_PLAN.md](docs/LEARNING_PLAN.md)。
